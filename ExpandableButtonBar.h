...
@protocol ExpandableButtonBarDelegate;

@interface ExpandableButtonBar : UIView{
    NSObject <ExpandableButtonBarDelegate> *_delegate;
    /* ---------------------------------------------------------
...
@property (nonatomic,strong) NSObject<ExpandableButtonBarDelegate> *delegate;
...
@protocol ExpandableButtonBarDelegate <NSObject>
