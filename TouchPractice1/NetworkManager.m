...
//    CFStringRef uuidStr;
    ...
    //do {
        /*[NSString stringWithFormat:@"%@%04d",xxx, int i++]
         %@ is replacement of following "xxx"()Objective C程式設計P.311-313
         %04d means four digits */
        result = [NSString stringWithFormat:@"%@/Documents/%@.png", NSHomeDirectory(),itemType];
...
//    assert(uuidStr != NULL);
//    
//    result = [NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"%@-%@", itemType, uuidStr]];
//    assert(result != nil);
//    
//    CFRelease(uuidStr);
//    CFRelease(uuid);
